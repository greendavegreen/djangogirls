...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'djangogirls.contrib.sites.migrations'
}
...
ACCOUNT_ADAPTER = 'djangogirls.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'djangogirls.users.adapters.SocialAccountAdapter'
